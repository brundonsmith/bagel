...
import { ArrayType, FuncType, RecordType, LiteralType, NamedType, ObjectType, PrimitiveType, ProcType, TupleType, TypeExpression, UnionType, UnknownType, Property, Arg, GenericType, ParenthesizedType, MaybeType, BoundGenericType, IteratorType, PlanType, GenericFuncType, GenericProcType, TypeParam, ErrorType, TypeofType, ElementofType, KeyofType, ValueofType, SpreadArgs, Args, RegularExpressionType, ReadonlyType, InterfaceType, AST_NOISE } from "../_model/type-expressions.ts";
...
// const LIB_LOCATION = '/Users/brundolf/git/bagel/lib/bgl'

const BGL_PRELUDE_DATA = [
    { module: LIB_LOCATION + '/core.bgl' as ModuleName, imports: [ 'log', 'logf', 'iter', 'memo', 'planned', 'Loading', 'action', 'UnknownObject', 'BagelConfig', 'Element', 'assert' ] },
